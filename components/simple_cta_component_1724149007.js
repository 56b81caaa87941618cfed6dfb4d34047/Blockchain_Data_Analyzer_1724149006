...
*/
Vue.component("simple_cta_component_1724149007", {
    template: `
        ...
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Harness the power of cutting-edge analytics to stay ahead in the dynamic world of blockchain</p>
                </div>
